...
class Node(Generic[NodeType]):
    ...
    @classmethod
    def get_edges(cls, info: Info) -> Collection[NodeType]:
        raise NotImplementedError
...
class ConnectionField(StrawberryField):
    ...
    def arguments(self) -> List[StrawberryArgument]:
        if not hasattr(self, "_conn_resolver"):
            self._conn_resolver = StrawberryResolver(connection_resolver(self))
        return super().arguments + cast(List[StrawberryArgument], self._conn_resolver.arguments)
    ...
    def resolve_connection(
        ...
        **kwargs: Dict[str, Any],
        ...
        return self._conn_resolver(**kwargs)(edges)  # type:ignore
